...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quetz-frontend-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10261&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/quetz-frontend-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quetz-frontend` can be installed with:

```
conda install quetz-frontend
```

It is possible to list all of the versions of `quetz-frontend` available on your platform with:
